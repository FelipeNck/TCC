...
function load() {
    ...
    for(var row=0;row<size;row++) {
        ...
        for(var col=0;col<size;col++) {
            var id = row+""+col;
            html += '<td align="center" valign="center" height="90" width="90" id="'+id+'"></td>';
        }
        html += '</tr>';
    }
    html += '</table>';
...
function checkWin(){
    ...
    for(var i=min;i<=max;i++) {
        for(var j=min;j<=max;j++) {
            var id = i+""+j;
            if(document.getElementById(id).innerHTML == "2048") {
                win2048 = true;
                break;
            }
        }
...
function calcScore(){
    ...
    for(var i=min;i<=max;i++) {
        for(var j=min;j<=max;j++) {
            var id = i+""+j;
            console.log(parseInt(document.getElementById(id).innerHTML))
            if(parseInt(document.getElementById(id).innerHTML) > preScore) {
                preScore = parseInt(document.getElementById(id).innerHTML);
            }
        }
    }
    switch(preScore){
        ...
        case 16:	score = 30; break;
        case 32:	score = 40; break;
        case 64:	score = 50; break;
        case 128:	score = 60; break;
        case 256:	score = 70; break;
        case 512:	score = 80; break;
        case 1024:	score = 100; break;
        case 2048:	score = 200; break;
...
function getColor(val)
{
    ...
    switch(val) {
        ...
        case 8:		color = "#f4b17a"; break;
        case 16:	color = "#f59575"; break;
        case 32:	color = "#f57c5f"; break;
        case 64:	color = "#f65d3b"; break;
        case 128:	color = "#edce71"; break;
        case 256:	color = "#edcc63"; break;
        case 512:	color = "#edc651"; break;
        case 1024:	color = "#eec744"; break;
        case 2048:	color = "#ecc230"; break;
        default:	color = "#cdc1b5";
    }
    return color;
}
...
function stopGame() {
    clearInterval(tempo);
    console.log(seg)
    setTimeout('window.location = "validar2048.php?pontuacao="+score+"&seg="+seg', 5000);
}
